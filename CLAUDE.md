...
- `docs/specs/` numbering: `00`–`11` core, in build order · `12`–`20` further
  accepted core work · specs and spikes share one number space (`21`–`23` are
  currently spikes; a promoted spike keeps its number) · `24`–`49` free ·
  `50`–`52` gamification (later phase, nothing in `00`–`20` may depend on it)
