...
Numbers `12`–`20` are accepted core work, `21`–`23` are claimed by spikes,
and `24`–`49` remain reserved (see `00-overview.md` for the shared
spec/spike number space).
Nothing in specs `00`–`20` may depend on anything defined here: the
